...
export class CustomerEditDialogComponent implements OnInit, OnDestroy {
	...
	createForm() {
		this.customerForm = this.fb.group({
			...
			mobile: [this.customer.mobile, Validators.compose([Validators.required])],
			company: [this.customer.company, Validators.compose([Validators.required])],
			ruc: [this.customer.ruc, Validators.compose([Validators.required])],
			address: [this.customer.address, Validators.compose([Validators.required])],
	...
	prepareCustomer(): CustomerModel {
		...
		_customer.mobile = controls.mobile.value;
		_customer.company = controls.company.value;
		_customer.ruc = controls.ruc.value;
